...
import { ChevronLeft, CreditCard, Wallet, Truck, Briefcase, Home, User, Navigation, Phone, ArrowLeft } from 'lucide-react';
...
const Checkout = ({
  ...
  return (
    <div className="w-full min-h-screen flex flex-col p-4 bg-white dark:bg-black">
      <div
        className="flex items-center gap-2 mb-4 lg:my-6 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
      >
        <ArrowLeft size={24} className="mt-1 cursor-pointer" onClick={() => setIsCheckingOut(false)}/>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex-grow">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              <div 
                className={`flex items-center gap-3 p-3 border rounded-md cursor-pointer ${paymentMethod === 'credit-card' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 dark:border-gray-700'}`}
              ...
              <div 
                className={`flex items-center gap-3 p-3 border rounded-md cursor-pointer ${paymentMethod === 'upi' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 dark:border-gray-700'}`}
              ...
              <div 
                className={`flex items-center gap-3 p-3 border rounded-md cursor-pointer ${paymentMethod === 'cod' ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 dark:border-gray-700'}`}
                onClick={() => setPaymentMethod('cod')}
              >
                <Truck className="text-gray-600 dark:text-gray-400" />
                <span className="text-gray-800 dark:text-gray-200">Cash on Delivery</span>
              </div>
            </div>
          </div>
          ...
          {paymentMethod === 'credit-card' && (
            <div className="mb-8">
              <h2 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Card Details</h2>
          ...
          {paymentMethod === 'upi' && (
            <div className="mb-8">
              <h2 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">UPI Details</h2>
              <div>
            ...
            {cartItems.map((item) => (
              <div key={item.id} className="flex items-center gap-4 pb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">Rs.{(item.price * item.qty).toFixed(2)}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="w-full lg:w-96 lg:sticky lg:top-4 lg:self-start  lg:mt-0">
          <div className="bg-gray-50 dark:bg-zinc-900 p-6 rounded-lg">
            <h2 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Order Total</h2>
            ...
            <div className="mb-6">
              ...
              {discount > 0 && (
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-sm text-green-600 dark:text-green-400">-Rs.{discount.toFixed(2)}</span>
                </div>
              )}
              <div className="flex justify-between mb-2">
